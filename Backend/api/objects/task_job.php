...
public $job_id;
	...
	function search($searchKey){
		...
		// select all query
		$query = "SELECT  t.* FROM ". $this->table_name ." t  WHERE t.task_id LIKE ? OR t.job_id LIKE ?  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
...
$stmt->bindParam(2, $searchKey);
	...
	function readOne(){
		...
		$query = "SELECT  t.* FROM ". $this->table_name ." t  WHERE t.task_id = ? LIMIT 0,1";
